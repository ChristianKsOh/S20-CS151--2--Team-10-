...
public class FormView extends UIPanel{
	...
	public FormView() {
				...
				THIsubmit.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if(count == 25) {
							THImessage.setText("Submitted successfully! Total: " + score);
							//-------------------------TODO-------------------------------
							//THICtrl.setScore(score);
							//System.out.println(THICtrl.getScore());
							//-------------------------TODO------------------------------
				...
				TFIsubmit.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if(count >= 19) {
							TFImessage.setText("Submitted successfully! Total: " + score);
							//-------------------------TODO----------------------------------
							//TFICtrl.setScore(score);
							//System.out.println(THICtrl.getScore());
							//-------------------------TODO---------------------------------
							//reset count and score
							count = score = 0;
	...
	public void refresh() {
		...
		//3 buttons: 25 questions: 3 sets o
		JRadioButton[][] THIanswers = new JRadioButton[25][3];	
		String[] THIlabel = new String[] { "Yes(4)", "Sometimes(2)", "No(0)" };
		//10 buttons: 25 questions
		JRadioButton[] TFIanswers = new JRadioButton[11];		
		//25 groups of 3 or 10
		ButtonGroup[] THIanswerGroup = new ButtonGroup[25];		
		ButtonGroup[] TFIanswerGroup = new ButtonGroup[25];
		...
		for(int i=0;i<25;i++) {
			...
			for(int k=0;k<11;k++) {
				...
				if(i == 0 || i == 2)		//percentages for q1 and q3
					...
					TFIanswers[k] = new JRadioButton(""+(k+1));
